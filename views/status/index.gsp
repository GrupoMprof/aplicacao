		...
		<div id="list-status" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'status.descricao.label', default: 'Descricao')}" />
				...
				<g:each in="${statusInstanceList}" status="i" var="statusInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${statusInstance.id}">${fieldValue(bean: statusInstance, field: "descricao")}</g:link></td>
